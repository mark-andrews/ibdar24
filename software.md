...
```r
devtools::install_git("https://github.com/mark-andrews/ibdar24.git", subdir = "priorexposure")
```
...
```r
devtools::install_github("mark-andrews/ibdar24", subdir = "priorexposure")
```
...
```r
devtools::install_github("mark-andrews/ibdar24", subdir = "priorexposure", upgrade = 'never')
```
