...
```r
devtools::install_git("https://github.com/ntu-stats-training/ibdar24.git", subdir = "priorexposure")
```
...
```r
devtools::install_github("ntu-stats-training/ibdar24", subdir = "priorexposure")
```
...
```r
devtools::install_github("ntu-stats-training/ibdar24", subdir = "priorexposure", upgrade = 'never')
```
